package com.conrad.weather.ui.theme
...
import com.conrad.ui.theme.AppTypography
...
private val DarkDomainColors = CustomColors(
    hot = HotDark,
    cold = ColdDark,
)

private val LightDomainColors = CustomColors(
    hot = HotLight,
    cold = ColdLight,
)

@Composable
fun ProvideDomainColors(
    darkTheme: Boolean = isSystemInDarkTheme(),
    content: @Composable () -> Unit
) {
    val colors = if (darkTheme) DarkDomainColors else LightDomainColors
    CompositionLocalProvider(LocalDomainColors provides colors) {
        content()
    }
}

val LocalDomainColors = compositionLocalOf { LightDomainColors }
